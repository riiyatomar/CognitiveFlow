...
- **Developed Real-Time Vision & Voice Interfaces**:  Web MediaStreams for webcam frame analysis and Web Speech API (STT / TTS) for hands-free speech interaction, featuring reactive state management (`isSpeaking`, `isListening`, `analyzing`).
